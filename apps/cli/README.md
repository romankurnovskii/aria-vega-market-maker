...
The `lp` tool allows operators to manually execute liquidity provision steps without running the full engine daemon. This is useful for emergency adjustments, testing new ranges, or one-off position management.

## Installation

The binary will be available as `lp` after building.
